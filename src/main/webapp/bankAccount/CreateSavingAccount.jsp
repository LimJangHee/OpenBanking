...
<body>
	...
	<div id="main" class="main">
		<!--  <h1>예금계좌 개설</h1> -->
		<form
			action="${pageContext.request.contextPath }/bankAccount/createSavingAccount.do"
			method="post">
			<div id="container">
				...
				<div class="inputDiv">
					<select style="width: 70px; height: 30px;" name="bankCode">
						<option value="a">JH Bank</option>
						<option value="b">CloudBank</option>
						<option value="c">JoyBank</option>
						<option value="d">CY Bank</option>
					</select> <input style="width: 170px;" type="number" name="phoneNum3"
						oninput="checkNumberLength(this)"
						value="${requestScope.phoneNum3}" placeholder="계좌번호"><br>
